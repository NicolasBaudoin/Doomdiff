...
module.exports = {
	data: new SlashCommandBuilder()  //create de command slash 
		.setName(`valaise-overwatch`)  //name of the command
		.setDescription('Donne les rangs de Valaise sur Overwatch'), //description
	async execute(interaction) {

        const response = await axios.get('https://overwatch.blizzard.com/fr-fr/career/valaise-2547/')
        ...
        .setTitle('Valaise est actuellement classé :')
        .setURL('https://overwatch.blizzard.com/fr-fr/career/valaise-2547/')
        .setFields(
