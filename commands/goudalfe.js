...
module.exports = {
	data: new SlashCommandBuilder()  //create de command slash 
		.setName(`goudalfe-overwatch`)  //name of the command
		.setDescription('Donne les rangs de Goudalfe sur Overwatch'), //description
	async execute(interaction) {

        const response = await axios.get('https://overwatch.blizzard.com/fr-fr/career/Goudalfe-2975/')
        ...
        .setTitle('Goudalfe est actuellement classé :')
        .setURL('https://overwatch.blizzard.com/fr-fr/career/Goudalfe-2975/')
        .setFields(
