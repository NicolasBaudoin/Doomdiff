...
module.exports = {
	data: new SlashCommandBuilder()  //create de command slash 
		.setName(`evenaros-overwatch`)  //name of the command
		.setDescription('Donne les rangs d\'Evenaros sur Overwatch'), //description
	async execute(interaction) {

        const response = await axios.get('https://overwatch.blizzard.com/fr-fr/career/Evenaros-2765/')
        ...
        .setTitle('Evenaros est actuellement classé :')
        .setURL('https://overwatch.blizzard.com/fr-fr/career/Evenaros-2765/')
        .setFields(
