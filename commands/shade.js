...
module.exports = {
	data: new SlashCommandBuilder()  //create de command slash 
		.setName(`shade-overwatch`)  //name of the command
		.setDescription('Donne les rangs de Shade sur Overwatch'), //description
	async execute(interaction) {

        const response = await axios.get('https://overwatch.blizzard.com/fr-fr/career/Shadeerilaz-2444/')
