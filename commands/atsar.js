...
module.exports = {
	data: new SlashCommandBuilder()  //create de command slash 
		.setName(`atsar-overwatch`)  //name of the command
		.setDescription(`Donne les rangs d'Atsar' sur Overwatch`), //description
	async execute(interaction) {

        const response = await axios.get('https://overwatch.blizzard.com/fr-fr/career/Atsar-2949/')
        const $ = cheerio.load(response.data)
        // Verify if Profile is private
        ...
        .setTitle('Atsar est actuellement classé :')
        .setURL('https://overwatch.blizzard.com/fr-fr/career/Atsar-2949/')
        .setFields(
